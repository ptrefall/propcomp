...
private:
	void set_component_private(CSSReplacedComponent *component);
	CSSLayoutObject(const std::shared_ptr<CSSLayoutNode_Impl> &impl);

	friend class CSSLayoutNode;
};

template<typename T>
void CSSLayoutObject::set_component(T *component)
{
