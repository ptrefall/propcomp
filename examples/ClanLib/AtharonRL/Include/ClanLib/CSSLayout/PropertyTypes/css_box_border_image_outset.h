...
class CSSBoxBorderImageOutset : public CSSBoxProperty
{
public:
	CSSBoxBorderImageOutset();
	void compute(const CSSBoxBorderImageOutset *parent, CSSResourceCache *layout, float em_size, float ex_size);
