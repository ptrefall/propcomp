...
public:
	...
	VirtualDirectoryListing(VirtualFileSource *provider, const std::string &path);

	virtual ~VirtualDirectoryListing();
...
private:
	std::shared_ptr<VirtualDirectoryListing_Impl> impl;
/// \}
};
