...
///    to keep a Slot reference around for each connection needed.</p>
...
public:
	/// \brief Connect a slot to a Signal_v0 signal.
	...
	/// \brief Connect a slot to a Signal_v0 signal with an user data parameter
	/// \brief passed along.
	...
	/// \brief Connect a slot to a Signal_v1 signal.
	...
	/// \brief Connect a slot to a Signal_v1 signal with an user data parameter
	/// \brief passed along.
	...
	/// \brief Connect a slot to a Signal_v2 signal.
	...
	/// \brief Connect a slot to a Signal_v2 signal with an user data parameter
	/// \brief passed along.
	...
	/// \brief Connect a slot to a Signal_v3 signal.
	...
	/// \brief Connect a slot to a Signal_v3 signal with an user data parameter
	/// \brief passed along.
	...
	/// \brief Connect a slot to a Signal_v4 signal.
	...
	/// \brief Connect a slot to a Signal_v4 signal with an user data parameter
	/// \brief passed along.
	...
	/// \brief Connect a slot to a Signal_v5 signal.
	...
	/// \brief Connect a slot to a Signal_v5 signal with an user data parameter
	/// \brief passed along.
