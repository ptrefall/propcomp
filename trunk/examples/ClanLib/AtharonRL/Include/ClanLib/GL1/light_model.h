...
///
/// \xmlonly !group=GL1/Display! !header=gl1.h! \endxmlonly
class CL_API_GL1 LightModel_GL1
{
//!Construction
public:
...
public:
	...
	void set_color_control(ColorControl_GL1 value);
	...
	void set_scene_ambient_light(Colorf color);

//!Implementation
private:
	std::shared_ptr<LightModel_GL1_Impl> impl;
};
