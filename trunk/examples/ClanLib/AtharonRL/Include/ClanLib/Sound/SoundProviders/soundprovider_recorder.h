...
class SoundProvider_Recorder_Impl;
...
class CL_API_SOUND SoundProvider_Recorder : public SoundProvider
{
/// \name Construction
/// \{
...
public:
	...
	SoundProvider_Recorder(
		int frequency = 22050);

	virtual ~SoundProvider_Recorder();
...
private:
	std::shared_ptr<SoundProvider_Recorder_Impl> impl;
/// \}
};
