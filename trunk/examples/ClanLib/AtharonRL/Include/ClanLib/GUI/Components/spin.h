...
public:
	...
	/// \brief Find the child Spin with the specified component ID name.
	///
	/// If it was not found, an exception is thrown.
	static Spin *get_named_item(GUIComponent *reference_component, const std::string &id);
