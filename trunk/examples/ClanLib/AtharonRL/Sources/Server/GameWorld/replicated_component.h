...
public:
	...
	void replicate_property(Totem::Property<char> &property, ReplicationMode mode = REPLICATE_ON_CREATION);
	void replicate_property(Totem::Property<std::string> &property, ReplicationMode mode = REPLICATE_ON_CREATION);
	void replicate_property(Totem::Property<clan::Vec2i> &property, ReplicationMode mode = REPLICATE_ON_CREATION);
