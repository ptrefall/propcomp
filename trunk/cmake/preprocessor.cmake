...
macro(define_output_paths package)
	...
	set(PACKAGE_SRCS_ADDONS_DIR ${PACKAGE_OUTPUT_DIR}/src/Addons)
	...
	message(STATUS "Output Path to Totem ${package} src/: ${PACKAGE_SRCS_DIR}")
	message(STATUS "Output Path to Totem ${package} include/Totem/: ${PACKAGE_HDRS_DIR}")
	message(STATUS "Output Path to Totem ${package} src/Addons/: ${PACKAGE_SRCS_ADDONS_DIR}")
...
macro(define_output_abs_paths package)
	...
	foreach(f ${totem_src_addon_files})
		set(package_src_addon_files ${package_src_addon_files} ${PACKAGE_SRCS_ADDONS_DIR}/${f})
	endforeach()
	...
	message(STATUS "Source Files to editions/${package}/src/ ${package_src_files}")
	message(STATUS "Header Files to editions/${package}/include/Totem/ ${package_hdr_files}")
	message(STATUS "Source Files to editions/${package}/src/Addons/ ${package_src_addon_files}")
...
macro(copy_totem_to_output package)
	...
	foreach(input ${totem_src_files_abs_path})
		list(GET package_src_files ${list_index} output)
	...
	set(list_count)
	set(list_index 0)
	list(LENGTH package_src_addon_files list_count)
	foreach(input ${totem_src_addon_files_abs_path})
		list(GET package_src_addon_files ${list_index} output)
		message(STATUS "Evaluating index ${list_index}/${list_count}: ${output}")
		MATH(EXPR list_index "${list_index}+1")
