...
public:
	 ...
	 */
	sigslot::signal0<> &registerToEvent0(HashedString1 type);
	 ...
	 */
	template<class T>
	sigslot::signal1<T> &registerToEvent1(HashedString1 type);
	 ...
	 */
	template<class T, class U>
	sigslot::signal2<T, U> &registerToEvent2(HashedString1 type);
	 ...
	 */
	template<class T, class U, class V>
	sigslot::signal3<T, U, V> &registerToEvent3(HashedString1 type);
	 ...
	 */
	template<class T, class U, class V, class W>
	sigslot::signal4<T, U, V, W> &registerToEvent4(HashedString1 type);
	 ...
	 */
	template<class T, class U, class V, class W, class X>
	sigslot::signal5<T, U, V, W, X> &registerToEvent5(HashedString1 type);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y>
	sigslot::signal6<T, U, V, W, X, Y> &registerToEvent6(HashedString1 type);
...
template<class EventFactory>
template<class T>
inline sigslot::signal1<T> &EventSystem<EventFactory>::registerToEvent1(HashedString1 type)
{
	auto it = events1.find(type.getId());
	if(it == events1.end())
	{
...
template<class EventFactory>
template<class T, class U>
inline sigslot::signal2<T, U> &EventSystem<EventFactory>::registerToEvent2(HashedString1 type)
{
	auto it = events2.find(type.getId());
	if(it == events2.end())
	{
...
template<class EventFactory>
template<class T, class U, class V>
inline sigslot::signal3<T, U, V> &EventSystem<EventFactory>::registerToEvent3(HashedString1 type)
{
	auto it = events3.find(type.getId());
	if(it == events3.end())
	{
...
template<class EventFactory>
template<class T, class U, class V, class W>
inline sigslot::signal4<T, U, V, W> &EventSystem<EventFactory>::registerToEvent4(HashedString1 type)
{
	auto it = events4.find(type.getId());
	if(it == events4.end())
	{
...
template<class EventFactory>
template<class T, class U, class V, class W, class X>
inline sigslot::signal5<T, U, V, W, X> &EventSystem<EventFactory>::registerToEvent5(HashedString1 type)
{
	auto it = events5.find(type.getId());
	if(it == events5.end())
	{
...
template<class EventFactory>
template<class T, class U, class V, class W, class X, class Y>
inline sigslot::signal6<T, U, V, W, X, Y> &EventSystem<EventFactory>::registerToEvent6(HashedString1 type)
{
	auto it = events6.find(type.getId());
	if(it == events6.end())
	{
