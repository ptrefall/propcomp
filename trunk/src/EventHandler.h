...
public:
	 ...
	 */
	template<class T, class U, class V> void onEvent3(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2);
	 ...
	 */
	template<class T, class U, class V, class W> void onEvent4(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3);
	 ...
	 */
	template<class T, class U, class V, class W, class X> void onEvent5(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y> void onEvent6(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y, class Z> void onEvent7(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5, const Z &arg6);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y, class Z, class S> void onEvent8(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5, const Z &arg6, const S &arg7);
	 ...
	 */
	template<class T, class U, class V>typename T_Signal_v3<const T&, const U&, const V&>::Type &registerToEvent3(const T_StringId &type);
	 ...
	 */
	template<class T, class U, class V, class W>typename T_Signal_v4<const T&, const U&, const V&, const W&>::Type &registerToEvent4(const T_StringId &type);
	 ...
	 */
	template<class T, class U, class V, class W, class X>typename T_Signal_v5<const T&, const U&, const V&, const W&, const X&>::Type &registerToEvent5(const T_StringId &type);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y>typename T_Signal_v6<const T&, const U&, const V&, const W&, const X&, const Y&>::Type &registerToEvent6(const T_StringId &type);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y, class Z>typename T_Signal_v7<const T&, const U&, const V&, const W&, const X&, const Y&, const Z&>::Type &registerToEvent7(const T_StringId &type);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y, class Z, class S>typename T_Signal_v8<const T&, const U&, const V&, const W&, const X&, const Y&, const Z&, const S&>::Type &registerToEvent8(const T_StringId &type);
...
inline void EventHandler::onEvent0(const T_StringId &type)
{
...
template<class T>
inline void EventHandler::onEvent1(const T_StringId &type, const T &arg0)
{
...
inline void EventHandler::onEvent2(const T_StringId &type, const T &arg0, const U &arg1)
{
...
inline void EventHandler::onEvent3(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2)
{
	T_Map<T_StringIdType, IEventSignal*>::Type::iterator it = events3.find(type.getId());
	if(it == events3.end())
...
inline void EventHandler::onEvent4(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3)
{
	T_Map<T_StringIdType, IEventSignal*>::Type::iterator it = events4.find(type.getId());
	if(it == events4.end())
...
inline void EventHandler::onEvent5(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4)
{
	T_Map<T_StringIdType, IEventSignal*>::Type::iterator it = events5.find(type.getId());
	if(it == events5.end())
...
inline void EventHandler::onEvent6(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5)
{
	T_Map<T_StringIdType, IEventSignal*>::Type::iterator it = events6.find(type.getId());
	if(it == events6.end())
...
inline void EventHandler::onEvent7(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5, const Z &arg6)
{
	T_Map<T_StringIdType, IEventSignal*>::Type::iterator it = events7.find(type.getId());
	if(it == events7.end())
...
inline void EventHandler::onEvent8(const T_StringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5, const Z &arg6, const S &arg7)
{
	T_Map<T_StringIdType, IEventSignal*>::Type::iterator it = events8.find(type.getId());
	if(it == events8.end())
...
inline T_Signal_v0<>::Type &EventHandler::registerToEvent0(const T_StringId &type)
{
...
template<class T>
inline typename T_Signal_v1<const T&>::Type &EventHandler::registerToEvent1(const T_StringId &type)
{
...
template<class T, class U>
inline typename T_Signal_v2<const T&, const U&>::Type &EventHandler::registerToEvent2(const T_StringId &type)
{
...
template<class T, class U, class V>
inline typename T_Signal_v3<const T&, const U&, const V&>::Type &EventHandler::registerToEvent3(const T_StringId &type)
{
...
template<class T, class U, class V, class W>
inline typename T_Signal_v4<const T&, const U&, const V&, const W&>::Type &EventHandler::registerToEvent4(const T_StringId &type)
{
...
template<class T, class U, class V, class W, class X>
inline typename T_Signal_v5<const T&, const U&, const V&, const W&, const X&>::Type &EventHandler::registerToEvent5(const T_StringId &type)
{
...
template<class T, class U, class V, class W, class X, class Y>
inline typename T_Signal_v6<const T&, const U&, const V&, const W&, const X&, const Y&>::Type &EventHandler::registerToEvent6(const T_StringId &type)
{
...
template<class T, class U, class V, class W, class X, class Y, class Z>
inline typename T_Signal_v7<const T&, const U&, const V&, const W&, const X&, const Y&, const Z&>::Type &EventHandler::registerToEvent7(const T_StringId &type)
{
...
template<class T, class U, class V, class W, class X, class Y, class Z, class S>
inline typename T_Signal_v8<const T&, const U&, const V&, const W&, const X&, const Y&, const Z&, const S&>::Type &EventHandler::registerToEvent8(const T_StringId &type)
{
