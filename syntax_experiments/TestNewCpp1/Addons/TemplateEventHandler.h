...
protected:
	...
	T_Map<unsigned int, IEventSignal*>::Type events0;
	/// Map of event signals with one argument held by TemplateEventHandler.
	T_Map<unsigned int, IEventSignal*>::Type events1;
	/// Map of event signals with two arguments held by TemplateEventHandler.
	T_Map<unsigned int, IEventSignal*>::Type events2;
	/// Map of event signals with three arguments held by TemplateEventHandler.
	T_Map<unsigned int, IEventSignal*>::Type events3;
	/// Map of event signals with four arguments held by TemplateEventHandler.
	T_Map<unsigned int, IEventSignal*>::Type events4;
	/// Map of event signals with five arguments held by TemplateEventHandler.
	T_Map<unsigned int, IEventSignal*>::Type events5;
	/// Map of event signals with six arguments held by TemplateEventHandler.
	T_Map<unsigned int, IEventSignal*>::Type events6;
};

//------------------------------------------------------

inline void TemplateEventHandler::sendEvent0(const HashedString &type)
{
	T_Map<unsigned int, IEventSignal*>::Type::iterator it = events0.find(type.getId());
	if(it == events0.end())
...
template<class T>
inline void TemplateEventHandler::sendEvent1(const HashedString &type, T arg0)
{
	T_Map<unsigned int, IEventSignal*>::Type::iterator it = events1.find(type.getId());
	if(it == events1.end())
...
template<class T, class U>
inline void TemplateEventHandler::sendEvent2(const HashedString &type, T arg0, U arg1)
{
	T_Map<unsigned int, IEventSignal*>::Type::iterator it = events2.find(type.getId());
	if(it == events2.end())
...
template<class T, class U, class V>
inline void TemplateEventHandler::sendEvent3(const HashedString &type, T arg0, U arg1, V arg2)
{
	T_Map<unsigned int, IEventSignal*>::Type::iterator it = events3.find(type.getId());
	if(it == events3.end())
...
template<class T, class U, class V, class W>
inline void TemplateEventHandler::sendEvent4(const HashedString &type, T arg0, U arg1, V arg2, W arg3)
{
	T_Map<unsigned int, IEventSignal*>::Type::iterator it = events4.find(type.getId());
	if(it == events4.end())
...
template<class T, class U, class V, class W, class X>
inline void TemplateEventHandler::sendEvent5(const HashedString &type, T arg0, U arg1, V arg2, W arg3, X arg4)
{
	T_Map<unsigned int, IEventSignal*>::Type::iterator it = events5.find(type.getId());
	if(it == events5.end())
...
template<class T, class U, class V, class W, class X, class Y>
inline void TemplateEventHandler::sendEvent6(const HashedString &type, T arg0, U arg1, V arg2, W arg3, X arg4, Y arg5)
{
	T_Map<unsigned int, IEventSignal*>::Type::iterator it = events6.find(type.getId());
	if(it == events6.end())
...
inline T_Signal_v0<>::Type &TemplateEventHandler::registerToEvent0(const HashedString &type)
{
...
template<class T>
inline typename T_Signal_v1<T>::Type &TemplateEventHandler::registerToEvent1(const HashedString &type)
{
...
template<class T, class U>
inline typename T_Signal_v2<T, U>::Type &TemplateEventHandler::registerToEvent2(const HashedString &type)
{
...
template<class T, class U, class V>
inline typename T_Signal_v3<T, U, V>::Type &TemplateEventHandler::registerToEvent3(const HashedString &type)
{
...
template<class T, class U, class V, class W>
inline typename T_Signal_v4<T, U, V, W>::Type &TemplateEventHandler::registerToEvent4(const HashedString &type)
{
...
template<class T, class U, class V, class W, class X>
inline typename T_Signal_v5<T, U, V, W, X>::Type &TemplateEventHandler::registerToEvent5(const HashedString &type)
{
...
template<class T, class U, class V, class W, class X, class Y>
inline typename T_Signal_v6<T, U, V, W, X, Y>::Type &TemplateEventHandler::registerToEvent6(const HashedString &type)
{
