...
public:
	 ...
	 */
	void sendEvent0(const T_HashedStringId &type);
	 ...
	 */
	template<class T> void sendEvent1(const T_HashedStringId &type, const T &arg0);
	 ...
	 */
	template<class T, class U> void sendEvent2(const T_HashedStringId &type, const T &arg0, const U &arg1);
	 ...
	 */
	template<class T, class U, class V> void sendEvent3(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2);
	 ...
	 */
	template<class T, class U, class V, class W> void sendEvent4(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3);
	 ...
	 */
	template<class T, class U, class V, class W, class X> void sendEvent5(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y> void sendEvent6(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y, class Z> void sendEvent7(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5, const Z &arg6);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y, class Z, class S> void sendEvent8(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5, const Z &arg6, const S &arg7);
	 ...
	 */
	T_Signal_v0<>::Type &registerToEvent0(const T_HashedStringId &type);
	 ...
	 */
	template<class T>typename T_Signal_v1<const T&>::Type &registerToEvent1(const T_HashedStringId &type);
	 ...
	 */
	template<class T, class U>typename T_Signal_v2<const T&, const U&>::Type &registerToEvent2(const T_HashedStringId &type);
	 ...
	 */
	template<class T, class U, class V>typename T_Signal_v3<const T&, const U&, const V&>::Type &registerToEvent3(const T_HashedStringId &type);
	 ...
	 */
	template<class T, class U, class V, class W>typename T_Signal_v4<const T&, const U&, const V&, const W&>::Type &registerToEvent4(const T_HashedStringId &type);
	 ...
	 */
	template<class T, class U, class V, class W, class X>typename T_Signal_v5<const T&, const U&, const V&, const W&, const X&>::Type &registerToEvent5(const T_HashedStringId &type);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y>typename T_Signal_v6<const T&, const U&, const V&, const W&, const X&, const Y&>::Type &registerToEvent6(const T_HashedStringId &type);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y, class Z>typename T_Signal_v7<const T&, const U&, const V&, const W&, const X&, const Y&, const Z&>::Type &registerToEvent7(const T_HashedStringId &type);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y, class Z, class S>typename T_Signal_v8<const T&, const U&, const V&, const W&, const X&, const Y&, const Z&, const S&>::Type &registerToEvent8(const T_HashedStringId &type);
...
protected:
	...
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events0;
	/// Map of event signals with one argument held by EventHandler.
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events1;
	/// Map of event signals with two arguments held by EventHandler.
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events2;
	/// Map of event signals with three arguments held by EventHandler.
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events3;
	/// Map of event signals with four arguments held by EventHandler.
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events4;
	/// Map of event signals with five arguments held by EventHandler.
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events5;
	/// Map of event signals with six arguments held by EventHandler.
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events6;
	/// Map of event signals with seven arguments held by EventHandler.
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events7;
	/// Map of event signals with eight arguments held by EventHandler.
	T_Map<T_HashedStringIdType, IEventSignal*>::Type events8;
};

//------------------------------------------------------

inline void EventHandler::sendEvent0(const T_HashedStringId &type)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events0.find(type.getId());
	if(it == events0.end())
...
template<class T>
inline void EventHandler::sendEvent1(const T_HashedStringId &type, const T &arg0)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events1.find(type.getId());
	if(it == events1.end())
...
inline void EventHandler::sendEvent2(const T_HashedStringId &type, const T &arg0, const U &arg1)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events2.find(type.getId());
	if(it == events2.end())
...
inline void EventHandler::sendEvent3(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events3.find(type.getId());
	if(it == events3.end())
...
inline void EventHandler::sendEvent4(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events4.find(type.getId());
	if(it == events4.end())
...
inline void EventHandler::sendEvent5(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events5.find(type.getId());
	if(it == events5.end())
...
inline void EventHandler::sendEvent6(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events6.find(type.getId());
	if(it == events6.end())
...
inline void EventHandler::sendEvent7(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5, const Z &arg6)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events7.find(type.getId());
	if(it == events7.end())
...
inline void EventHandler::sendEvent8(const T_HashedStringId &type, const T &arg0, const U &arg1, const V &arg2, const W &arg3, const X &arg4, const Y &arg5, const Z &arg6, const S &arg7)
{
	T_Map<T_HashedStringIdType, IEventSignal*>::Type::iterator it = events8.find(type.getId());
	if(it == events8.end())
...
inline T_Signal_v0<>::Type &EventHandler::registerToEvent0(const T_HashedStringId &type)
{
...
template<class T>
inline typename T_Signal_v1<const T&>::Type &EventHandler::registerToEvent1(const T_HashedStringId &type)
{
...
template<class T, class U>
inline typename T_Signal_v2<const T&, const U&>::Type &EventHandler::registerToEvent2(const T_HashedStringId &type)
{
...
template<class T, class U, class V>
inline typename T_Signal_v3<const T&, const U&, const V&>::Type &EventHandler::registerToEvent3(const T_HashedStringId &type)
{
...
template<class T, class U, class V, class W>
inline typename T_Signal_v4<const T&, const U&, const V&, const W&>::Type &EventHandler::registerToEvent4(const T_HashedStringId &type)
{
...
template<class T, class U, class V, class W, class X>
inline typename T_Signal_v5<const T&, const U&, const V&, const W&, const X&>::Type &EventHandler::registerToEvent5(const T_HashedStringId &type)
{
...
template<class T, class U, class V, class W, class X, class Y>
inline typename T_Signal_v6<const T&, const U&, const V&, const W&, const X&, const Y&>::Type &EventHandler::registerToEvent6(const T_HashedStringId &type)
{
...
template<class T, class U, class V, class W, class X, class Y, class Z>
inline typename T_Signal_v7<const T&, const U&, const V&, const W&, const X&, const Y&, const Z&>::Type &EventHandler::registerToEvent7(const T_HashedStringId &type)
{
...
template<class T, class U, class V, class W, class X, class Y, class Z, class S>
inline typename T_Signal_v8<const T&, const U&, const V&, const W&, const X&, const Y&, const Z&, const S&>::Type &EventHandler::registerToEvent8(const T_HashedStringId &type)
{
