...
public:
	 ...
	 */
	template<class T>
	sigslot::signal1<T> &registerToEvent1(HashedString type);
	 ...
	 */
	template<class T, class U>
	sigslot::signal2<T, U> &registerToEvent2(HashedString type);
	 ...
	 */
	template<class T, class U, class V>
	sigslot::signal3<T, U, V> &registerToEvent3(HashedString type);
	 ...
	 */
	template<class T, class U, class V, class W>
	sigslot::signal4<T, U, V, W> &registerToEvent4(HashedString type);
	 ...
	 */
	template<class T, class U, class V, class W, class X>
	sigslot::signal5<T, U, V, W, X> &registerToEvent5(HashedString type);
	 ...
	 */
	template<class T, class U, class V, class W, class X, class Y>
	sigslot::signal6<T, U, V, W, X, Y> &registerToEvent6(HashedString type);
